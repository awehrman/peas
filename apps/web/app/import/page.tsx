...
import { PendingReview, RecentlyImported, FileUpload } from "@peas/ui";
...
export default function ImportPageRoute(): ReactNode {
  ...
  const recentlyImportedItems = [
    ...
    { text: "Added note \"Summer Peach Fattoush\" with ID 12345.", indentLevel: 1 },
    { text: "Successfully uploaded image.", indentLevel: 1 },
    { text: "Starting processing note content (5%):", indentLevel: 1 },
    { text: "...[0%] Processing 0 out of 10 ingredient lines.", indentLevel: 2 },
    { text: "...[10%] Processing 1 out of 10 instruction lines.", indentLevel: 2 },
