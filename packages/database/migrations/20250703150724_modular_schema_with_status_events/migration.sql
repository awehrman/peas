...
-- CreateEnum
CREATE TYPE "NoteStatus" AS ENUM ('PENDING', 'PROCESSING', 'COMPLETED', 'FAILED');
...
CREATE TABLE "NoteStatusEvent" (
    ...
    CONSTRAINT "NoteStatusEvent_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "NoteStatusEvent_noteId_idx" ON "NoteStatusEvent"("noteId");

-- CreateIndex
CREATE INDEX "NoteStatusEvent_status_idx" ON "NoteStatusEvent"("status");

-- CreateIndex
CREATE INDEX "NoteStatusEvent_createdAt_idx" ON "NoteStatusEvent"("createdAt");
...
-- AddForeignKey
ALTER TABLE "NoteStatusEvent" ADD CONSTRAINT "NoteStatusEvent_noteId_fkey" FOREIGN KEY ("noteId") REFERENCES "Note"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
